Q_all = 'L1tcalo:GOOD,L1tmu:GOOD,Hlt:GOOD,Lumi:GOOD,All:GOOD'
...
my_dict  = {"BTagCSV"         :  {"QFLAGS": [Q_all, Q_1, Q_2, Q_3, Q_4],
           ...
           "Charmonium"       :  {"QFLAGS": [Q_all, Q_1,           Q_4],
                                  "DCS"   : [       d_1,           d_4]},
           "DisplacedJet"     :  {"QFLAGS": [Q_all, Q_1, Q_2, Q_3     ],
                                  "DCS"   : [       d_1, d_2, d_3     ]},
           "DoubleEG"         :  {"QFLAGS": [Q_all, Q_1, Q_2          ],
                                  "DCS"   : [       d_1, d_2          ]},
           "DoubleMuon"       :  {"QFLAGS": [Q_all, Q_1,           Q_4],
                                  "DCS"   : [       d_1,           d_4]},
           "DoubleMuonLowMass":  {"QFLAGS": [Q_all, Q_1,           Q_4],
                                  "DCS"   : [       d_1,           d_4]},
           "HTMHT"            :  {"QFLAGS": [Q_all, Q_1, Q_2, Q_3     ],
                                  "DCS"   : [       d_1, d_2, d_3     ]},
           "JetHT"            :  {"QFLAGS": [Q_all, Q_1, Q_2, Q_3     ],
                                  "DCS"   : [       d_1, d_2, d_3     ]},                                             
           ...
           "MuOnia"           :  {"QFLAGS": [Q_all, Q_1,           Q_4],
                                  "DCS"   : [       d_1,           d_4]},
           "SingleElectron"   :  {"QFLAGS": [Q_all, Q_1, Q_2          ],
                                  "DCS"   : [       d_1, d_2          ]},
           "SingleMuon"       :  {"QFLAGS": [Q_all, Q_1,           Q_4],
                                  "DCS"   : [       d_1,           d_4]},
           "SinglePhoton"     :  {"QFLAGS": [Q_all,      Q_2          ],
                                  "DCS"   : [            d_2          ]},
           "Tau"              :  {"QFLAGS": [Q_all, Q_1, Q_2, Q_3, Q_4],
                                  "DCS"   : [       d_1, d_2, d_3, d_4]},
           "ZeroBias"         :  {"QFLAGS": [Q_all, Q_1               ],
                                  "DCS"   : [       d_1               ]}
          }
